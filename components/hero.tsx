    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 text-pretty">
          Two specialized divisions. One powerful partnership. We deliver cutting-edge solutions 
          for prop firms, brokers, and businesses seeking exceptional full-stack development.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <div className="flex items-center gap-3 px-5 py-3 rounded-full bg-card border border-border">
            ...
            <span className="text-sm font-medium text-foreground">Trading Division</span>
          </div>
          <div className="flex items-center gap-3 px-5 py-3 rounded-full bg-card border border-border">
            <Code2 className="h-5 w-5 text-accent" />
            <span className="text-sm font-medium text-foreground">Development Division</span>
          </div>
        </div>
      </div>
