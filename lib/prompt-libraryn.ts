...
export const ANTHROPIC_PRINCIPLES: Snippet[] = [
  ...
  },
  {
   ...
   category: 'vibe',
   priority: 'high',
   prompt: 'modern corporate aesthetic, clean professional design, navy/slate blues, confident typography, trust-building layout, enterprise SaaS feel',
   conflicts: ['brutalism', 'memphis', 'psychedelic', 'vaporwave'],
 ...
 },
 {
   ...
   category: 'vibe',
   prompt: 'mythical fantasy aesthetic, deep purples and golds, ornate decorative borders, magical particle effects, ancient runes motifs, ethereal glow, mystical atmosphere',
   conflicts: ['minimal-light', 'swiss-style', 'brutalism', 'modern-corporate'],
   tags: ['fantasy', 'magic', 'ornate'],
 },
 {
   id: 'classical-baroque',
   label: '🏛️ Classical/Baroque',
   category: 'vibe',
   prompt: 'classical baroque aesthetic, ornate gold flourishes, cream and burgundy palette, serif typography, symmetrical compositions, renaissance painting inspired, luxurious and timeless',
   conflicts: ['cyberpunk', 'brutalism', 'memphis', 'vaporwave', 'minimal-light'],
   tags: ['classical', 'ornate', 'luxury'],
 },
 {
   id: 'startup-saas',
   label: '🚀 Startup SaaS',
   category: 'vibe',
   prompt: 'modern startup SaaS aesthetic, gradient hero, feature cards, social proof sections, clean pricing tables, conversion-optimized layout, YCombinator-era design language',
   conflicts: ['brutalism', 'memphis', 'classical-baroque'],
 ...
 },
 {
   ...
   label: '🎨 Street Art',
   category: 'vibe',
   prompt: 'street art graffiti aesthetic, bold spray-paint typography, urban textures, high contrast colors, raw energy, stencil effects, city grit',
   conflicts: ['minimal-light', 'japandi', 'classical-baroque', 'swiss-style'],
   tags: ['urban', 'graffiti', 'raw'],
 },
 {
   id: 'bauhaus',
   label: '⬛ Bauhaus',
   category: 'vibe',
   prompt: 'Bauhaus design movement, primary colors (red/blue/yellow) on white, geometric forms only, form follows function, strong grid, sans-serif typography, no decoration',
   conflicts: ['classical-baroque', 'memphis', 'organic', 'mythical-fantasy'],
   tags: ['geometric', 'minimal', 'primary'],
 },
 {
   id: 'art-deco',
   label: '✦ Art Deco',
   category: 'vibe',
   prompt: 'Art Deco aesthetic, gold and black palette, geometric sunburst patterns, stepped architectural motifs, glamorous 1920s luxury, bold symmetry, metallic accents',
   conflicts: ['brutalism', 'minimal-light', 'cyberpunk', 'memphis'],
   tags: ['deco', 'gold', '1920s'],
 },
 {
   id: 'psychedelic',
   label: '🌀 Psychedelic',
   category: 'vibe',
   prompt: 'psychedelic aesthetic, swirling kaleidoscopic patterns, neon rainbow gradients, warped typography, 60s-70s trippy visuals, optical illusion elements',
   conflicts: ['minimal-light', 'swiss-style', 'japandi', 'modern-corporate', 'bauhaus'],
   tags: ['psychedelic', 'colorful', 'trippy'],
 },
 {
   id: 'cottagecore',
   label: '🌸 Cottagecore',
   category: 'vibe',
   prompt: 'cottagecore aesthetic, soft pastels, floral patterns, warm cream backgrounds, hand-drawn illustration feel, cozy countryside charm, botanical motifs',
   conflicts: ['cyberpunk', 'brutalism', 'dark-luxury', 'scifi-hud'],
   tags: ['cozy', 'floral', 'soft'],
 },
 {
   id: 'noir',
   label: '🕵️ Noir/Detective',
   category: 'vibe',
   prompt: 'film noir aesthetic, high contrast black and white with single accent color, dramatic shadows, rain-slicked streets mood, 1940s detective atmosphere, moody typography',
   conflicts: ['minimal-light', 'playful-colorful', 'memphis', 'cottagecore'],
 ...
 },
 {
   ...
   category: 'vibe',
   prompt: 'underwater ocean aesthetic, deep teal and navy blues, bioluminescent accent glows, fluid wave animations, caustic light patterns, serene aquatic depth',
   conflicts: ['brutalism', 'memphis', 'vaporwave'],
   tags: ['ocean', 'blue', 'fluid'],
 },
 {
   id: 'dark-forest',
   label: '🌲 Dark Forest',
   category: 'vibe',
   prompt: 'dark enchanted forest aesthetic, deep greens and blacks, misty atmospheric depth, organic textures, moonlit highlights, mysterious and immersive',
   conflicts: ['minimal-light', 'brutalism', 'swiss-style'],
   tags: ['forest', 'dark', 'organic'],
 },
 {
   id: 'neon-noir',
   label: '🌃 Neon Noir',
   category: 'vibe',
   prompt: 'neon noir aesthetic, rain-soaked dark streets, pink and purple neon reflections, cinematic wide compositions, blade runner atmosphere, romantic dystopia',
   conflicts: ['minimal-light', 'cottagecore', 'bauhaus'],
   tags: ['neon', 'noir', 'cinematic'],
 },
 {
   id: 'maximalism',
   label: '🎭 Maximalism',
   category: 'vibe',
   prompt: 'maximalist design, more is more philosophy, layered textures and patterns, rich color combinations, bold typography collisions, visual abundance, organized chaos',
   conflicts: ['minimal-light', 'japandi', 'swiss-style', 'bauhaus', 'flat-design'],
   tags: ['bold', 'layered', 'rich'],
 },
