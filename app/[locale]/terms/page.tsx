...
export default function TermsPage({ params }: { params: { locale: Locale } }) {
  ...
  return (
    <LegalPageLayout title={t.title} lastUpdated={lastUpdatedText} backToHome={dict.common.backToHome} locale={params.locale} privacyLabel={dict.nav.privacyPolicy} termsLabel={dict.nav.termsOfService} disclaimerLabel={dict.nav.disclaimer} copyright={copyright}>
